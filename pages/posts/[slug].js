...
export default function PostPage({
  ...
  return (
    <Layout>
      ...
      <article className="px-6 md:px-0 text-left">
        <header>
          <h1 className="font-serif text-3xl md:text-5xl dark:text-white mb-10">
            {frontMatter.title}
          </h1>
        ...
        <div className="grid md:grid-cols-2 lg:-mx-24 mt-12">
          {prevPost && (
            <Link href={`/posts/${prevPost.slug}`}>
              <a className="py-8 px-10 text-center md:text-right first:rounded-t md:first:rounded-tr-none md:first:rounded-l last:rounded-r first last:rounded-b backdrop-blur bg-white dark:bg-black dark:bg-opacity-30 bg-opacity-10 hover:bg-opacity-20 dark:hover:bg-opacity-50 transition border border-gray-800 dark:border-white border-opacity-10 dark:border-opacity-10 last:border-t md:border-r-0 md:last:border-r md:last:rounded-r-none flex flex-col">
